...
/*------------短链数据库创建-----------------*/
CREATE DATABASE IF NOT EXISTS `dcloud_link`;
CREATE DATABASE IF NOT EXISTS `dcloud_link_0`;
CREATE DATABASE IF NOT EXISTS `dcloud_link_1`;
CREATE DATABASE IF NOT EXISTS `dcloud_link_a`;
/*------------短链数据库创建-----------------*/
...
(
    ...
    `title`        varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Group Name',
    `account_no`   bigint                                                 DEFAULT NULL COMMENT 'Account',
...
(
    `id`           bigint unsigned                                       NOT NULL,
    `group_id`     bigint                                                  DEFAULT NULL COMMENT '分组',
